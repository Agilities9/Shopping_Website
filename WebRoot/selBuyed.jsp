...
<center  style="padding-top:50px">
  ...
  <tr>
    ...
    <td><%=goods.getGoodsDe() %></td>
   
    </tr>
    <tr>
     <td colspan="3"><center>
     <a href="payforServlet?goodId=<%=goods.getGoodsId()%>&userId=<%=Integer.parseInt(String.valueOf(session.getAttribute("userId"))) %>&isflag='go'">立即购买</a>
     <a href="doShoppingServlet">加入购入车</a>
